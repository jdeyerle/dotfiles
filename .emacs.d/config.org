...
(defun my/turn-off-line-numbers-hook ()
...
(use-package treemacs
  ...
  (treemacs-width 30)
  :hook (treemacs-mode . my/turn-off-line-numbers-hook)
  :bind (("<f8>" . treemacs)
...
(use-package term
  :hook (term-mode . my/turn-off-line-numbers-hook))

(use-package vterm
  :commands vterm
  :hook (vterm-mode . my/turn-off-line-numbers-hook))

(use-package eshell
  :hook ((eshell-mode . my/turn-off-line-numbers-hook)
...
(use-package cider
  :hook (cider-repl-mode . my/turn-off-line-numbers-hook))
#+end_src
